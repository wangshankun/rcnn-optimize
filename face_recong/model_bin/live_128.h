...
#ifndef _GLOW_BUNDLE_LIVE_128_H
#define _GLOW_BUNDLE_LIVE_128_H
...
// ---------------------------------------------------------------
// Model name: "live_128"
// Total data size: 254400 (bytes)
// Placeholders:
//
//   Name: "input"
//   Type: float<1 x 1 x 128 x 128>
//   Size: 16384 (elements)
//   Size: 65536 (bytes)
//   Offset: 0 (bytes)
//
//   Name: "scores"
//   Type: float<1 x 172 x 2>
//   Size: 344 (elements)
//   Size: 1376 (bytes)
//   Offset: 65536 (bytes)
//
//   Name: "boxes"
//   Type: float<1 x 172 x 4>
//   Size: 688 (elements)
//   Size: 2752 (bytes)
//   Offset: 66944 (bytes)
//
...
#define LIVE_128_input   0
#define LIVE_128_scores  65536
#define LIVE_128_boxes   66944

// Memory sizes (bytes).
#define LIVE_128_CONSTANT_MEM_SIZE     86400
#define LIVE_128_MUTABLE_MEM_SIZE      69696
#define LIVE_128_ACTIVATIONS_MEM_SIZE  98304

// Memory alignment (bytes).
#define LIVE_128_MEM_ALIGN  64

// Bundle entry point (inference function). Returns 0
// for correct execution or some error code otherwise.
int live_128(uint8_t *constantWeight, uint8_t *mutableWeight, uint8_t *activations);
