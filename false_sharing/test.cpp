...
int main()
{
    Counters test1(1, 1);//step为1,连续数组
    test1.Test();
    Counters test2(2, 1);
    test2.Test();
    Counters test4(4, 1);
    ...
    Counters test8(8, 1);
    test8.Test();
    Counters test16(16, 1);
    test16.Test();
    
    Counters test_sk_cacheline1(1, 32);
    test_sk_cacheline1.Test();
    Counters test_sk_cacheline2(2, 32);
    test_sk_cacheline2.Test();
    Counters test_sk_cacheline4(4, 32);
    test_sk_cacheline4.Test();
    Counters test_sk_cacheline8(8, 32);
    test_sk_cacheline8.Test();
    Counters test_sk_cacheline16(16, 32);
    test_sk_cacheline16.Test();
}
