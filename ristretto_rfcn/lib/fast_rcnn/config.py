...
#__C.TEST.SCALES = (150,)
#__C.TEST.MAX_SIZE = 250
#__C.TRAIN.SCALES = (150,)
#__C.TRAIN.MAX_SIZE = 250

#__C.TEST.SCALES = (216,)
#__C.TEST.MAX_SIZE = 360
#__C.TRAIN.SCALES = (216,)
...
__C.TRAIN.RPN_NORMALIZE_TARGETS = True
...
__C.MODELS_DIR = osp.abspath(osp.join(__C.ROOT_DIR, 'models', 'container_digits'))
...
def get_output_dir(imdb, net=None):
    ...
    outdir = osp.abspath(osp.join(__C.ROOT_DIR,__C.EXP_DIR, imdb.name))
    if net is not None:
