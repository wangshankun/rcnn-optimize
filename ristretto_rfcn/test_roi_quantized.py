...
if __name__ == '__main__':
    test_prototxt  = './models/ristretto/test_zf_rfcn_quantized.prototxt'
    test_caffemodel  = './models/normal/zf_rfcn.caffemodel'#也可以使用微调后的caffemodel
    ...
    for im_name in im_names[:100]:#测试文件个数
